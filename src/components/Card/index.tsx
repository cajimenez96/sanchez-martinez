...
const Card: React.FC<CardProps> = ({className, children, handleClick}) => {
  return (
    <div className={`w-[350px] md:w-[400px] max-h-[520px] text-ellipsis lg:mx-10 group cursor-pointer ${className}`} onClick={handleClick}>
      {children}
    </div>
  )
}
